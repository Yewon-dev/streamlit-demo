...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='bedroom.yml')#, required=True, help='Path to the config file')
    ...
    parser.add_argument('--npy_name', type=str, default='lsun_bedroom3')#, required=True)
